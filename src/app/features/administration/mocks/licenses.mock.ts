...
export const MOCK_LICENSES: License[] = [
  {
    ...
    productId: 'WLN-001', productName: 'Plena', orderId: '#SAN-9021',
  ...
  },
  {
    ...
    productId: 'WLN-001', productName: 'Plena', orderId: '#SAN-9019',
    status: 'available', generatedAt: '2026-05-23',
  },
  {
    id: 'l3', code: 'SN-Z9-1142', batchId: 'Lote #38-B',
    productId: 'WLN-002', productName: 'Serenity Kit', orderId: '#SAN-9014',
  ...
  },
  {
    ...
    productId: 'WLN-001', productName: 'Plena', orderId: '#SAN-9017',
  ...
  },
  {
    ...
    productId: 'WLN-002', productName: 'Serenity Kit', orderId: '#SAN-9015',
  ...
  },
  {
    ...
    productId: 'WLN-001', productName: 'Plena', orderId: '#SAN-9005',
    status: 'available', generatedAt: '2026-05-10',
  },
  {
    id: 'l7', code: 'SN-P9-0044', batchId: 'Lote #38-B',
    productId: 'WLN-002', productName: 'Serenity Kit', orderId: '#SAN-9008',
  ...
  },
  {
    ...
    productId: 'WLN-001', productName: 'Plena', orderId: '#SAN-9018',
